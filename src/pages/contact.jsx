...
function Contact() {
    ...
    <Navbar />
        <div className='bg-white'>
            ...
            <section class="pt-24 max-w-[1200px] px-12 mx-auto bg-white">
                <div ><h2 class="font-semibold text-4xl mb-2 section-title text-black" >
    ...
    <p className='text-black'>Mijn naam is Lars Vermeulen ik ben een 17 jaar oude student op het Grafisch Lyceum in Rotterdam. De opleiding die ik doe is Software Developer momenteel zit ik in het tweede leerjaar. Zelf heb ik al mijn examen Front-end succesvol afgerond en ook nog mijn examen ( Het beheren van virtuele machines met een virtueel ingestelde router). </p>
    <p class="mt-2 text-black">Ik ben een positief ingestelde jongen die heel leer gierig is en goed kan omgaan in een groep. Als er problemen zijn met het coderen zoek ik graag naar oplossingen voor het probleem en dat motiveert mij weer bij de opdracht. </p>
    ...
    <div class="social-links flex flex-row gap-4">
        <a href="">
            <img src="/assets/phone2.png" class="w-12 h-12" viewBox="0 0 24 24"></img></a> <p className='text-black'>U kunt me bellen via 0638272089</p>
            <a href="mailto:larsvermeulenxx@gmail.com">
                <img alt="github-social" src="/assets/email.png" class="w-12 aspect-square h-12 object-cover bg-white" /></a><p className='text-black'>Of via mijn mail ( klik op het icoon om mij te mailenn )</p></div>
                </div>
