...
<article class="md:col-span-2"><h5 class="font-bold text-sky-400">       Een foto van mij</h5><br/> <div class=" aspect-square relative overflow-hidden"><div class="image-container" ><img  class="object-contain "   src="/assets/port.jpeg" /></div></div></article></article>
            </section>
        </div>
    )
}
